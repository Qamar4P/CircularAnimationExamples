 ...
 * for no border.
 */
public class FreqDiffIndicator2 extends View {
    ...
    public FreqDiffIndicator2(Context context) {
        super(context);
        init();
    }
...
//    }
    ...
    public FreqDiffIndicator2(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public FreqDiffIndicator2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
